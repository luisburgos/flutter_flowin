...
class FlowinTheme {
  ...
  static ThemeData _build(ColorScheme colorScheme, FlowinTokens tokens) {
    ...
    // widget build exhausts the JS stack — see [FDIcons.internalWarmUp]. A
    // theme is always built before any icon renders, and at a far shallower
    // stack, so this covers consuming apps without exposing anything for them
    // to call.
    FDIcons.internalWarmUp();
